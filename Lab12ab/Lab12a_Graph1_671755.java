...
public class Lab12a_Graph1_671755 {
    ...
    static void q1_1() {
        ...
        GraphList_671755 graphL = new GraphList_671755(5);
        graphL.addEdge(0, 1);
        graphL.addEdge(0, 4);
        graphL.addEdge(1, 2);
        graphL.addEdge(1, 3);
    ...
    static void q1_2() {
        ...
        GraphMap_671755 graphM = new GraphMap_671755();
        graphM.addEdge(1, 2);
        graphM.addEdge(1, 3);
        graphM.addEdge(2, 4);
        graphM.printGraph();
    ...
    static void q1_3() {
        ...
        GraphNode_671755 graphN = new GraphNode_671755();
    ...
    stack.add(0);
    while (!stack.isEmpty()) {
        int parent = stack.removeLast();
        visited.add(parent);
        for (int x = 0; x < thisGraph.length; x++) {
            if (thisGraph[parent][x] != INF && thisGraph[parent][x] != 0) {
