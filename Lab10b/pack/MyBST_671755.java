...
public class MyBST_671755 extends MyBST_Basic_671755 {
    public MyBST_671755() { super(); };
    public MyBST_671755(Integer[] input) {
        super(input);
    }
    public BNode getRoot() {
        return super.getRoot();        /* your code 1 */
    }
    ...
    public static void leftRotate(MyBST_671755 bst, BNode node) {
    ...
    public static void rightRotate(MyBST_671755 bst, BNode node) {
    ...
    public static void rightLeftRotate(MyBST_671755 bst, BNode node) {
        if (node == null || node.right == null) return;
