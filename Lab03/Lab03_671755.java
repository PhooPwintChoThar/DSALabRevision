...
import Lab03.pack.MyArray_671755;
import Lab03.pack.MyArrayBasic_671755;

public class Lab03_671755 {
    static private void arrayBasic_demo_1() {
        MyArrayBasic_671755 demo = new MyArrayBasic_671755(7,6,8,1,2,3);
        System.out.println( demo );
    }
    static private void arrayBasic_demo_2() {
        MyArrayBasic_671755 demo = new MyArrayBasic_671755();
    ...
    static void array_demo_4() {
        MyArray_671755 demo = new MyArray_671755(5);
        demo.delete(0);
        demo.add(3);    
        demo.add(7);
        demo.add(5);    
...
static void array_demo_5() {
    MyArray_671755 demo = new MyArray_671755();
    demo.insert_unordered(0,9);
    demo.insert_unordered(0,7); 
    ...
    static void array_demo_6() {
        ...
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            ...
            MyArray_671755 mArray = new MyArray_671755(200_000/40_000);
            for (int n = 1; n < N; n++)
        ...
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            ...
            MyArray_671755 mArray = new MyArray_671755();
            for (int n = 1; n < N; n++)
                mArray.add((int)(Math.random()*1000));
            long time = System.currentTimeMillis() - start;
            System.out.println(N + "\t\t" + time);        
